...
export default function ProductsItem({ProductList,ProductDetailAction,AjouterCart}) {
    ...
    return(
        ...
        <img onClick={ProductDetailAction} className={` ${Style.img}  w-max h-1/2 object-center`} src={ProductList.Image[0]} alt={ProductList.Image[0]}/>
        ...
        <div className="px-6 pt-4 pb-2 h-60">
          ...
          <span onClick={AjouterCart} className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Ajouter</span>
